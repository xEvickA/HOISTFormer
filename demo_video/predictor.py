...
from mask2former_video.data_video.datasets.hoist import *

class VisualizationDemo(object):
    def __init__(self, cfg_file, weights, instance_mode=ColorMode.IMAGE, parallel=False):
        """
        Args:
            cfg (CfgNode):
